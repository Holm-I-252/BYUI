...
while running:
    ...
    if dark_room == "left":
        ...
        if pot == "green":
            print(f"{name} reaches their hand into the green pot and is bitten by a venomus snake! The venom acts quickly, causing your blood to light on fire, turning you to a pile of ash. GAME OVER.")
            ...
            print(f"{name} reaches their hand into the blue pot and feels something cold and metal at the bottom. A key perchance? {name} pulls out the object and realizes its the lid to a little box inisde the pot. Out of the box comes a blue mist that fills the room. The room gets colder and colder from the mist, until {name} is encased in a solid block of ice. GAME OVER.")
